...
TurnableContext.prototype.N10 = function() {
...
NearbyParser.prototype.turnable = function() {
    ...
    try {
        ...
        this.state = 195;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << NearbyParser.N1) | (1 << NearbyParser.N2) | (1 << NearbyParser.N7) | (1 << NearbyParser.N8) | (1 << NearbyParser.N9) | (1 << NearbyParser.N10))) !== 0))) {
...
DimmableContext.prototype.N10 = function() {
    return this.getToken(NearbyParser.N10, 0);
};
